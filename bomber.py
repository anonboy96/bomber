...
def bann_text():
   ...
   █████                 ██🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴
   ██▒▒██                ██
   ██  ██        ██   ██ ██                 MADE BY ANONBOY96 Aka umang patel
   █████▒  ████  ███ ███ █████
   ██▒▒██ ██  ██ ██▒█▒██ ██▒▒██ 🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴
   ██  ██ ██  ██ ██ ▒ ██ ██  ██
   █████▒ ▒████▒ ██   ██ █████▒
...
def check_intr():
    try:
        requests.get("https://btechkers.netlify.app")
    except Exception:
        bann_text()
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("UBomber was created by Anonboy")
    mesgdcrt.SuccessMessage("UBomber was modified by Anonboy")
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("UBomber will work only in Python v3")
    sys.exit()
...
description = """UBomber - Your Friendly Spammer Application
...
UBomber is not intented for malicious uses.
"""
